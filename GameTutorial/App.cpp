...
struct App : implements<App, IFrameworkViewSource, IFrameworkView>
{
    ...
    /***
    * creates a randomly colored square at the click coordinates
    **/
    void AddVisual(float2 const point)
    {
        ...
        static unsigned last = 0; // staatic variable in a fn means memory is allocated for the duration of the program
        unsigned const next = ++last % _countof(colors); // unsigned -> only positive numbers
